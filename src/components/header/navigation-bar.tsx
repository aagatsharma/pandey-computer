            ...
            <NavigationMenuList>
              <NavigationMenuItem>
                <NavigationMenuLink asChild>
                  <Link
                    href="/"
                    className={`group inline-flex h-10 md:h-12 w-max items-center justify-center rounded-md px-3 md:px-5 py-2 text-sm md:text-base lg:text-lg font-medium transition-colors outline-none disabled:pointer-events-none disabled:opacity-50 ${
                      pathname === "/"
